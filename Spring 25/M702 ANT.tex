...
\begin{document}
    ...
    \underline{Functorial Description of the Carter Dual}: Let \(G = \operatorname{Spec}(A) \in \operatorname{Gps}_R^{\text{fin,proj}}\) for \(R^{\prime} \in R\)-alg (= cattegory of comm. \(R\)-algebras) we define:
