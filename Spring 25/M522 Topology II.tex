...
\begin{document}
    ...
    \begin{center}
        \begin{tikzcd}
            & \widetilde{X} \ar[d] \\ \Delta^n \ar[ur, "\widetilde{\sigma}_1 \text{,}\widetilde{\sigma}_2"] \ar[r,"\sigma"] & X
        \end{tikzcd}, \(\tau(\sigma) = \widetilde{\sigma }_1 + \widetilde{\sigma}_2\) 
    \end{center}

    \begin{center}
        \begin{tikzcd}
            & (\overline{X},\overline{x}_0) \ar[d] \\ (Y,y_0) \ar[ru,dotted,"\exists"] \ar[r] & (X,x_0)
        \end{tikzcd} \(\iff\) \begin{tikzcd}
            & \pi_1(\overline{X},\overline{x}_0) \ar[d] \\ \pi_1(Y,y_0) \ar[ru,dotted,"\exists"] \ar[r] & \pi_1(X,x_0)
        \end{tikzcd}
    \end{center}
    ...
    \begin{center}
        \begin{tikzcd}
            \widetilde{X} \ar[r] \ar[d] & X \ar[d] \\ \widetilde{Y} \ar[r] & Y
        \end{tikzcd}
    \end{center}
    ...
    We have \(X = e^0 \cup e^1 \cup e^2\) with \(\partial e^2 = 3 e_1\).

    \(C_\bullet X = \mathbb{Z} [e_2] \to \mathbb{Z}[e_1] \to \mathbb{Z} [e_0]\) 

    \(\cong \mathbb{Z} \xrightarrow{3} \mathbb{Z} \xrightarrow{0} \mathbb{Z}\).

    \(H_{\ast} X = \{ \mathbb{Z} , \mathbb{Z} / 3, 0, 0, \cdots \}\)

    \(C^\bullet X = \mathbb{Z} \widehat{e^2} \xleftarrow{\delta^1} \mathbb{Z} \widehat{e^1} \xleftarrow{\delta^0} \mathbb{Z} \widehat{e^0}\)

    Where \(\widehat{e^2}\) etc are linear functionals. Calculating, we have:

    \(\mathbb{Z} \xleftarrow{3} \mathbb{Z} \xleftarrow{0} \mathbb{Z}\)

    \(H^n X = \begin{dcases}
        \mathbb{Z}, &\text{ if } n=0 ;\\
        0, &\text{ if } n\neq 0,2 ;\\
        \mathbb{Z} / 3, &\text{ if } n=2 .
    \end{dcases}\)
    
    We get the `whole package' from homology.

    \(H^{\ast} (\text{pt})\)

    \(H^{\ast} (\coprod X_\alpha)\) 

    \(H^0\) 

    \(\widetilde{H}^{\ast}\) 

    \(\widetilde{H}^{\ast} (\vee X_\alpha)\) 
    ...
    \(H^{\ast} (\text{pt}) = \{ \mathbb{Z} , 0, 0, \cdots \}\).
    
    \(H^{\ast} (\coprod X_\alpha) \cong \prod H^{\ast} (X_\alpha)\) [dual of direct sum is direct product]

    \(H^0 X = \prod_{\text{path components of \(X\)}} \mathbb{Z} \)
    
    Suppose we have:

    \[
        \cdots \to S_2 X \to S_1 X \to S_0 X \xrightarrow{\epsilon} \mathbb{Z} \to 0
    \]
