...
\begin{theorem}
    ...
    \begin{enumerate}[label=\alph*)]
        \item isomorphism classes of simple \(kG\)-modules \(\stackrel{\overset{s^{\ast}}{\rightarrow}}{\underset{\pi^{\ast}}{\leftarrow} }\)  isomorphism classes of simple \(kQ\)-modules.
        \item isomorphism classes of projective indecomposable \(kG\) modules \(\stackrel{\overset{\pi_{\ast}}{\rightarrow}}{\underset{s_{\ast}}{\leftarrow} }\) isomorphism classes of projective indecomposable \(kQ\)-modules.
        \item isomorphism classes of projective indecomposable \(AG\)-modules \(\stackrel{\overset{\pi_{\ast}}{\rightarrow}}{\underset{s_{\ast}}{\leftarrow} }\) isomorphism classes of projective indecomposable \(AQ\)-modules. 
    \end{enumerate} 
\end{theorem}

\begin{remark}
    \(E \cong \pi ^{\ast} F \iff P\) acts trivially on \(E\).

    Will prove: \(\pi^{\ast}, \pi_{\ast} , \pi_{\ast}\) are bijections, \(s^{\ast},s_{\ast} , s_{\ast}\) are \(1\)-sided inverses \(\iff\) 2-sided inverses.

    \(kG / J(kG) \cong kQ\).
\end{remark}

\begin{proof}
    a and b are general facts:

    \(R\) artinian means \(R / J\) is the maximal semisimple quotient. We have \(R \overset{\pi}{\to} R / J\).

    Then we have simple \(R\)-mod \(\overset{\pi^{\ast}}{\underset{\cong}{\leftarrow}}\) simple \(R / J\)-mod.
    
    Recall \(J = \bigcap_{\text{simple \(R\)-mod } E} \operatorname{Ann}(E)\).
    
    p.i \(R\)-mod \(\overset{\pi^{\ast}}{\underset{\cong}{\to}}\) simple \(R / J\)-mod by projective cover.
    
    Thus we are done with a and b.

    c: 

    \begin{center}
        \begin{tikzcd}
            \text{p.i } AG\text{-mod} \ar[r,"\pi_\ast","\pi\text{ split}"'] \ar[d,tail,"p_\ast","14.4"'] & \text{p.i }AQ\text{-mod}\ar[d,"p_\ast\,15.5\text{ Maschke}","\cong"'] \\ \text{p.i } kG\text{-mod} \ar[r,"\pi_\ast","\cong\,(b)"'] & \text{p.i }kQ\text{-mod}
        \end{tikzcd}
    \end{center}
\end{proof}
...
\begin{proof}
    ...
    \begin{center}
        \begin{tikzcd}
            K_0 kG & R_k Q \ar[l, "s_\ast"', "\cong"] \ar[r, "\pi^\ast","\cong"'] & R_k G \ar[l, bend right, "s^\ast"'] \\ \text{basis}  & \text{basis} & \text{basis} \\ s_\ast F_1, \cdots, s_\ast F_t & F_1, \cdots, F_t & \pi^\ast F_1, \cdots, \pi^\ast F_t
        \end{tikzcd}
    \end{center}
...
\begin{proof}
    ...
    \begin{center}
        \begin{tikzcd}
            R_{\mathbb{Q}(\zeta_m)}(G) \ar[r, "\cong"] \ar[d,"\cong"] & R_{\mathbb{C}} G \\ R_K G
        \end{tikzcd}
    \end{center}
\end{proof}
...
\begin{center}
    \begin{tikzcd}
        K_0 k G \ar[rr, tail, "c"] \ar[rd, tail, "e"] & & R_k G \\ & R_K G \ar[ur, two heads, "d"]
    \end{tikzcd}
\end{center}
...
\begin{center}
    \begin{tikzcd}
        & K^\prime & & k^\prime \\ K \ar[ur, no head] & & k \ar[ur, no head]
    \end{tikzcd}
\end{center}
...
\begin{center}
    \begin{tikzcd}
        kG \ar[rr, tail] \ar[rd,"e"] & & K_0 k^\prime G \ar[ll, bend right, dotted, "14.6"] \ar[rd, tail] \\ & R_K G \ar[rr] & & R_{K^\prime} G \ar[ul, bend right, dotted]
    \end{tikzcd}
\end{center}
...
\begin{center}
    \begin{tikzcd}
        K_0 k G \ar[rd] \\ K_0 k G \times K_0 k G \ar[u, "1 \times c"] \ar[r,,"\beta"'] & \mathbb{Z}
    \end{tikzcd}
\end{center} 
...
\begin{proof}
    \begin{center}
        \begin{tikzcd}
            K_0 k G\ar[rr, bend right,"e"] & K_0 A G \ar[l,"\cong"] \ar[r] & K_0 K G 
        \end{tikzcd}
    \end{center}
...
\begin{center}
    \begin{tikzcd}
        G_{\text{reg}} \ar[d, hook] \ar[rrr, "\phi_E", "\text{Brauer character}"'] & & & A \ar[d, two heads] \\ G \ar[rrr, "\chi_E"] & & & k
    \end{tikzcd}
\end{center}
...
\begin{center}
    \begin{tikzcd}
        N_K \ar[r, "\cong"] \ar[d, hook] & N_k \ar[d, hook] \\ A \ar[r, two heads] & k
    \end{tikzcd}
\end{center}
...
\begin{center}
    \begin{tikzcd}
        \Phi_F: G \to A & & \phi_E: G_{\text{reg}} \to A \\ K_0 k G \ar[rr,tail, "c"] \ar[rd,tail, "e"] &  & R_k G \\ & R_K G \ar[ru, "d", two heads] \\ & \chi_V: G \to A
    \end{tikzcd}
\end{center}
