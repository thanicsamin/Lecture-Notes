...
\begin{document}
    ...
    This corresponds to the linear algebra definition for \(V\). Orientation of \(V\) corresponds to \(\frac{\text{ordered bases \((b_1, ..., b_n)\) for \(V\)}}{(b_1, \cdots, b_n) \sim (b_1^{\prime}, \cdots, b_n^{\prime})\text{ if determinant of change of basis matrix is positive}}\).
