...
\begin{document}
    ...
    Suppose we have schemes \(X\) and \(Y\). A rational map is an equivalence class of pairs \((U,\pi)\) where \(U\) is a dense open subset of \(X\) [thought of as an open subscheme] where \(\pi: U \to Y\).
