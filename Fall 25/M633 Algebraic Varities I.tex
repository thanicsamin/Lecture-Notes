...
\begin{document}
    ...
    Existence of \(S ^{-1} A\) is expressed by yhe existence of an initial object in this category.
    ...
    Note that if we have a map of rings \(A \to B\), the map of schems go in the opposite direction: \(\operatorname{Spec} B \to \operatorname{Spec} A\). So there should be a final object in the category of schemes.
