...
\begin{center}
    \begin{tikzcd}
        K_0(kG) \ar[rr, "e", bend left] & K_0(AG) \ar[l, "\cong"] \ar[r] & K_0(KG) \\ \overline{p} \ar[r,mapsto] & p & KG \otimes_{AG} P \\ & & \vert\vert \\ & & K \otimes_A P
    \end{tikzcd}
\end{center}
...
\begin{proof}
    ...
    Special Case: \(\mathfrak{m} E_1 \subset E_2 \subset E_1\) 
