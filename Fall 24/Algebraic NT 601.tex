...
\usepackage{amsmath, amsthm, amssymb, amsfonts, mathtools, enumitem, fancyhdr, stmaryrd, physics, bbm}
\usepackage{tikz-cd}
\usepackage{graphicx}
\usepackage{float}
\usepackage{booktabs}
...
\begin{proof}
    ...
    \(\implies \mathcal{O}_E = N + \omega \mathcal{O}_E = N + \omega(N + \omega \mathcal{O}_E) \overset{\text{repeat}}{=} N + \omega N + \cdots + \omega^{e-1} N + \omega^e \mathcal{O}_E\) 
\end{proof}
