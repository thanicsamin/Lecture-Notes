...
\begin{document}
    ...
    For existence of SW (and chern) classes, instead of Steenrod squares, we can try to take \(f^{\ast} \operatorname{w}(E) = \operatorname{w}(L_1) \cdots \operatorname{w}(L_n)\).
